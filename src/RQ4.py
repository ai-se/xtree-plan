    ...
    for proj, paths in data.iteritems():
        ...
        for train, test, validation in zip(paths.data[:-2], paths.data[1:-1], paths.data[2:]):
            ...
            for rep in xrange(n_reps):
                ...
                # "Gather results"
                # _xtree.append(xtree_inc_auc)
                # _alves.append(alves_inc_auc)
                # _shatw.append(shatw_inc_auc)
                # _olive.append(olive_inc_auc)
                ...
                if verbose:
                    print("{}-{},{},{},{},{}".format(proj, i, xtree_dec_auc,
                                                     alves_dec_auc, shatw_dec_auc, olive_dec_auc))
